...
export default function LeadershipCard({ name, role, image, linkedin }: LeadershipCardProps) {
  return (
    <div className="card-ieee text-center hover:shadow-lg transition-all duration-300">
